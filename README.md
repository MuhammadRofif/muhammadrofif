...
<head>
  ...
  <style>
    body {
      background-image: url('https://i.pinimg.com/originals/59/b2/34/59b2349684d902730f710b65f05ecb80.gif');
    ...
    .content {
      background-color: rgba(0, 0, 0, 0.7); /* Adding a translucent dark background to make text readable */
      padding: 20px;
      border-radius: 10px;
    }
    .img-container {
...
<body>
  ...
  <div class="content">
    <h1>✨ Hello World! I'm Muhammad Rofif ✨</h1>
    <h3>Code Enthusiast | Setia | Problem Solver</h3>
    ...
    <p>Hi! 👋 Saya adalah seorang pengembang yang sangat antusias dengan teknologi modern. Saya percaya bahwa kode bukan hanya alat, tetapi juga seni yang dapat mengubah dunia. <strong>Tunduk kepada tradisi? Cih, tidak akan!</strong> Berdiri tegak dan menghadapi dengan keberanian adalah jalanku!</p>
